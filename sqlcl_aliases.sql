...
alias aviews=select apex_view_name from apex_dictionary where column_id = 0 order by 1;
alias aviewsf=select apex_view_name from apex_dictionary where column_id = 0 and apex_view_name like '%' || upper(:view_name) || '%' order by 1;
set define #
alias ae=q'<
set define &
